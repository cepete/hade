...
#define MIN_VERSION_network_transport_tcp(major1,major2,minor) (\
  ...
  (major1) == 0 && (major2) == 8 && (minor) <= 0)
#endif /* MIN_VERSION_network_transport_tcp */
/* package network-transport-tests-0.3.0 */
#ifndef VERSION_network_transport_tests
#define VERSION_network_transport_tests "0.3.0"
#endif /* VERSION_network_transport_tests */
#ifndef MIN_VERSION_network_transport_tests
#define MIN_VERSION_network_transport_tests(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 0)
#endif /* MIN_VERSION_network_transport_tests */
...
#define CURRENT_COMPONENT_ID "network-transport-tcp-0.8.0-31GhGAJhVNoJk6rLFQVqi2-TestTCP"
