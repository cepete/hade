...
#define CURRENT_PACKAGE_KEY "network-transport-tcp-0.8.0-GZOtquRlGrgHFeYMoPC4s8"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "network-transport-tcp-0.8.0-GZOtquRlGrgHFeYMoPC4s8"
