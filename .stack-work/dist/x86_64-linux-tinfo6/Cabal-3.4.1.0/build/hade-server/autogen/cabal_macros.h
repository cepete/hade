...
/* package servant-js-0.9.4.2 */
#ifndef VERSION_servant_js
#define VERSION_servant_js "0.9.4.2"
#endif /* VERSION_servant_js */
#ifndef MIN_VERSION_servant_js
#define MIN_VERSION_servant_js(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  9 || \
  (major1) == 0 && (major2) == 9 && (minor) <= 4)
#endif /* MIN_VERSION_servant_js */
...
#define CURRENT_COMPONENT_ID "hade-0.1.0.0-7f6O1Lramil6gbGXwIWjqa-hade-server"
